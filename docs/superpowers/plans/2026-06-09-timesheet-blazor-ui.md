...
- [ ] Jobs editor — settings, custom fields (show-on-timesheet), project codes, archive, state override, decimal places, work days
- [ ] Export — pick job + scope (week/month/FY), preview, download `.xlsx` via `IExportService`
- [ ] Profile — display name, default state, sign-in methods
